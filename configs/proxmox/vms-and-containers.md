...
| 200 | china-mode | Stopped | 2 | 1 GB | 8 GB | vmbr1 tag=20, 172.16.20.21/24 | China Mode GFW stack. Pi-hole (Alibaba DNS + AD forwarding to .20), nginx (CN headers), mitmproxy (ad inject). `onboot: 0` — managed via china-on.sh / china-off.sh |
