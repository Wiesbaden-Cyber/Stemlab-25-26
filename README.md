...
|---------|------|-------------|
| stemlab-drinks | [Wiesbaden-Cyber/stemlab-drinks](https://github.com/Wiesbaden-Cyber/stemlab-drinks) | Drink ordering web app — Node.js/Express + PostgreSQL, deployed on dolus via Docker Compose |
...
|------|------|--------|---------|---------|
| 10 | Lab | 172.16.10.0/24 | 172.16.10.1 | Lab servers and devices |
| 20 | Classroom | 172.16.20.0/24 | 172.16.20.1 | Student PCs, Windows Server, FreeRADIUS |
| 30 | Guest | 172.16.30.0/24 | 172.16.30.1 | Guest WiFi — internet only |
| 67 | Management | 172.16.67.0/28 | 172.16.67.1 | Infrastructure SSH/management — restricted access |

### Core Infrastructure

| Device | Role | IP | Hardware | OS / Version |
|--------|------|----|----------|--------------|
| SillyRouter | WAN edge, NAT, DHCP, ACLs | 172.16.67.1 | Cisco ISR C1112-8PLTEEA | IOS XE 17.06.01a |
...
For full topology, DHCP reservations, and Tailscale node list see [`docs/network-overview.md`](docs/network-overview.md).
...
<img src="topology/network-topology.png" width="100%" alt="Network Topology Diagram">

### Services & Applications

<img src="topology/services-diagram.png" width="100%" alt="Services & Applications Diagram">

> Source files for these diagrams are maintained in draw.io. Export updated PNGs to `topology/` when making changes.
...
docs/
├── network-overview.md                # Full topology, VLANs, DHCP reservations, Tailscale
├── stemlab-drinks.md                  # Drink ordering service — API, DB schema, deployment
├── windows-domain.md                  # Windows domain, DC VMs, FreeRADIUS
├── china-mode.md                      # China Mode — GFW simulation on VLAN 20
├── security.md                        # Security hardening log and pending items
├── setup-guide.md                     # Complete from-scratch rebuild guide
└── guides/
